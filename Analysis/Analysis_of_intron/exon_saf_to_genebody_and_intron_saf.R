# Exon saf file is used to create genebody saf and intron saf files.
####
# https://github.com/charitylaw/Intron-reads/blob/master/Annotations/exon_saf_to_genebody_and_intron_saf.R
...
write.table(genebody, file="data/ref/Genebody.txt", row.names=FALSE, sep="\t")
intron <- makeIntronicAnno(anno)
write.table(intron, file="data/ref/Intron.txt", row.names=FALSE, sep="\t")
